...
#include "../include/minishell.h"
 ...
 char	**upd_matches(t_aster *astr, char **argv)
{
    int			k;
    char		**tmp;
 ...
 int	search_half_matches(char *pattern, t_aster *astr)
{
    int		tmp_k;
    int		tmp_j;
 ...
 void	compare_matches(t_aster *astr, char *pattern, char ***ret)
{
 ...
 char	**search_matches(t_shell *minishell, int *i, t_aster	*astr)
{
    char	**ret;
    char	*pattern;
